function view_clusters(features,labels,opts)
%VIEW_CLUSTERS - 2D or 3D view of clusters in feature space, colored by
%labels
%
% Syntax:  view_clusters(features,labels)
%
% Inputs:
%    features - RxL array of features (R>=2)
...
if (~isfield(opts,'marker_size')) opts.marker_size=6; end; % for 2D plot only

if nargin<1, test_view_clusters; return; end;
